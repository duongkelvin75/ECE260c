...
module Farrow_Canonic
 (input   clk,
  input   reset,
  input   clk_enable,
  input   signed [15:0] In1,    // sfix16_En14	incoming signal to be resampled
  input   [11:0] In2,           // ufix12_En8   mu, or offset
  output  ce_out,
  output  signed [15:0] Out1);   // sfix16_En14	resampled signal out

  wire                enb;
  logic signed [15:0] Delay_out1; // sfix16_En14
  logic signed [15:0] Delay_out1_1;  // sfix16_En14
  logic signed [15:0] Delay_out1_2;  // sfix16_En14
  logic signed [15:0] Delay10_out1;  // sfix16_En14
  ...
  logic signed [15:0] Delay4_out1;  // sfix16_En14
  ...
  logic [11:0] Delay14_out1;  // ufix12_En8
  ...
  logic signed [15:0] Delay1_out1;  // sfix16_En14
...
// registers
  ...
  always @(posedge clk )
    begin : reduced_process
      if (reset == 1'b1) begin
        Delay_out1_1 <= 16'sb0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk )
    begin : reduced_1_process
      if (reset == 1'b1) begin
        Delay_out1_2 <= 16'sb0000000000000000;
      end
      else begin
        if (enb) begin
...
// CSD Encoding (32768) : 1000000000000000; Cost (Adders) = 0
  assign Gain14_1 = {Delay_out1_1[15], {Delay_out1_1, 15'b000000000000000}};
...
// multiply by 1/3, with rounding
  assign Gain5_mul_temp = 16'sb1010101010101011 * Delay_out1;
  ...
  assign Add7_add_cast = {{4{Delay_out1_2[15]}}, {Delay_out1_2, 6'b000000}};
  ...
  assign Gain4_cast = {{2{Delay_out1_2[15]}}, {Delay_out1_2, 14'b00000000000000}};
  ...
  assign Add11_sub_cast_1 = {Delay_out1_1[15], Delay_out1_1};
  ...
  assign Gain3_cast = {{2{Delay_out1_1[15]}}, {Delay_out1_1, 14'b00000000000000}};
...
// CSD Encoding (32768) : 1000000000000000; Cost (Adders) = 0
  assign Gain7_1 = {Delay_out1_2[15], {Delay_out1_2, 15'b000000000000000}};
  ...
  assign Product2_cast = {1'b0, Delay14_out1};
  assign Product2_mul_temp = Add12_out1 * Product2_cast;
  ...
  assign Product_cast = {1'b0, Delay14_out1};
  ...
  assign Product1_cast = {1'b0, Delay14_out1};
  assign Product1_mul_temp = Add4_out1 * Product1_cast;
  assign Product1_out1 = Product1_mul_temp[35:0];



  assign Add3_add_cast = {{7{Delay_out1_1[15]}}, {Delay_out1_1, 14'b00000000000000}};
