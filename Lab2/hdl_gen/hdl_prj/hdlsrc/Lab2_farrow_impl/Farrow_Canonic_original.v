// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\Lab2_farrow_impl\Farrow_Canonic.v
// Created: 2024-04-24 17:01:04
// 
...
// Source Path: Lab2_farrow_impl/Farrow_Canonic
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module Farrow_Canonic
  ...
  reg signed [15:0] Delay19_out1;  // sfix16_En14
  ...
  reg [11:0] Delay13_out1;  // ufix12_En8
  ...
  reg signed [23:0] Delay17_out1;  // sfix24_En20
  ...
  always @(posedge clk or posedge reset)
    begin : Delay19_process
      if (reset == 1'b1) begin
        Delay19_out1 <= 16'sb0000000000000000;
      end
      else begin
        if (enb) begin
          Delay19_out1 <= Delay15_out1;
        end
      end
    end
  ...
  assign Gain5_mul_temp = 16'sb1010101010101011 * Delay15_out1;
  ...
  assign Add5_add_cast = {Delay12_out1[17], {Delay12_out1, 6'b000000}};
  assign Add5_add_cast_1 = {Delay7_out1[23], Delay7_out1};
  ...
  assign Product_cast = {1'b0, Delay13_out1};
  ...
  always @(posedge clk or posedge reset)
    begin : Delay17_process
      if (reset == 1'b1) begin
        Delay17_out1 <= 24'sb000000000000000000000000;
      end
      else begin
        if (enb) begin
          Delay17_out1 <= Product_out1;
        end
      end
    end
  ...
  assign Add4_out1 = Delay16_out1 + Delay17_out1;
